...
import com.tcps.system.domain.vo.MetaVo;
import com.tcps.system.domain.vo.RouterVo;
import com.tcps.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus) {
        ...
        for (SysMenu menu : menus) {
            ...
            router.setMeta(new MetaVo(menu.getMenuName(), menu.getIcon(), StringUtils.equals("1", menu.getCache()), menu.getPath()));
            ...
            if (CollUtil.isNotEmpty(cMenus) && UserConstants.TYPE_DIR.equals(menu.getMenuType())) {
                ...
                children.setMeta(new MetaVo(menu.getMenuName(), menu.getIcon(), StringUtils.equals("1", menu.getCache()), menu.getPath()));
    ...
    public boolean isInnerLink(SysMenu menu) {
        return menu.getFrame().equals(UserConstants.NO_FRAME) && StringUtils.ishttp(menu.getPath());
    }
