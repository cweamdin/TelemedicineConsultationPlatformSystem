...
import com.tcps.common.constant.CacheConstants;
...
import com.tcps.common.core.domain.model.XcxLoginUser;
import com.tcps.common.enums.DeviceType;
import com.tcps.common.enums.LoginType;
import com.tcps.common.enums.UserStatus;
import com.tcps.common.exception.user.CaptchaException;
import com.tcps.common.exception.user.CaptchaExpireException;
...
public class SysLoginService {
    ...
    private SysUser loadUserByPhonenumber(String phonenumber) {
        SysUser user = userMapper.selectOne(new LambdaQueryWrapper<SysUser>()
            .select(SysUser::getPhone, SysUser::getStatus)
